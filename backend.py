...
def get_database_url():
    ...
    if not database_url:
        raise ValueError(
            "DATABASE_URL is missing. Please add your database URL to the .env file or set it as an environment variable."
        )
...
if not GROQ_API_KEY:
    raise ValueError(
        "GROQ_API_KEY is missing. Please add your Groq API key to the .env file or set it as an environment variable."
    )
    
if not GEMINI_API_KEY:
    raise ValueError(
        "GEMINI_API_KEY is missing. Please add your Google GenAI API key to the .env file or set it as an environment variable."
    )
